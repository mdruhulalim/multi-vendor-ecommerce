...
class VendorProductDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            //       <a class="dropdown-item has-icon" href="'.route('admin.products-image-callery.index', ['product'=>$query->id]).'"><i class="far fa-heart"></i>Images Gallery</a>
            ...
            //   </div>';
                $moreBtn = '<div class="btn-group dropstart" style="margin-left:4px;">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item has-icon" href="'.route('vendor.products-image-callery.index', ['product'=>$query->id]).'">Images Gallery</a></li>
            ...
            ->addColumn('image', function ($query) {
                return "<img width='100px' src='" . asset($query->thump_image) . "'></img>";
            })
